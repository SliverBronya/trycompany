...
public class PromptBuilder
{
    ...
    public String qaSystemPrompt()
    {
        return SYSTEM_PROMPT
             ...
             + "8. 【说话方式】像一位懂行的老技术员在田间讲话：先给结论，再说怎么做，把道理讲清楚。"
             + "不要堆套话，不要一段段背教科书，不要为了显得全面而罗列与此问无关的条目。\n"
             + "9. 【出处不许编】sources 用来说明你这次回答**站在哪类知识上**，逐条一行。\n"
             + "   能写清具体文献或机构就写；想不出确切名称的，写知识领域与原理\n"
             + "   （如「柑橘栽培学中采后施肥的通行做法」「植物营养学微量元素缺素诊断的常规方法」），\n"
             + "   让人知道结论的依据类型也是有用的。\n"
    ...
    public String qaUserPrompt(String question, TzKnowledgeBase entry)
    {
        ...
        if (entry == null)
        {
            ...
            sb.append("按系统提示词第 6、7 条处理：**用通用农艺知识正面回答**，")
